...
export class MockAuthenticationService implements AuthenticationServiceInterface {
  ...
  private userDb: [{ 
    email: string, password: string, token?: string, isBanned: boolean, isAdmin: boolean, isDriver: boolean, firstName?:string, lastName?:string, accountType?:string, document?:File,academicYearStart?: string, academicYearEnd?: string}] = [
    { email: "test@test.fr", password: "Test12+-", isBanned: false, isAdmin: false, isDriver: true }
  ]

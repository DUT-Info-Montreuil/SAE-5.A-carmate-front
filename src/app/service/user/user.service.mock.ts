...
export class MockUserService implements UserServiceInterface {
    ...
    private userDB: [{id: number, first_name: string, last_name: string, email_address: string, password: string, account_status: string, created_at: string, profile_picture: string | null}] = [
        {id: 1, first_name: "first_test", last_name: "last_test", email_address: "test@example.com", password: "pwd", account_status: "Teacher", created_at: this.current_time.toDateString(), profile_picture: null}
      ]

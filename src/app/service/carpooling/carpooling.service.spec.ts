...
import { CarpoolingServiceInterface, CreateCarpoolPayload } from 'src/app/interface/carpooling';
...
describe('CarpoolingService', () => {
  ...
  beforeEach(() => {
    ...
    spyCarpoolingService = new CarpoolingService(spyHttpClient, spyNotifierService);
  });

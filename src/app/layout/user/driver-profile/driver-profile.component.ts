...
import { DriverProfile } from 'src/app/model/profile.model';
...
export class DriverProfileComponent {
  ...
  constructor(
    ...
    private driverProfilesService: ProfilesServiceInterface,
  ...
  ngOnInit() {
    this.userService.getUser().subscribe({
      next: (user: User) => {
        ...
        this.driverProfilesService
          .getDriverProfile(localStorage.getItem('auth_token') ?? '')
          .subscribe({

...
import { SCORE_SERVICE_TOKEN, ScoreServiceInterface } from 'src/app/interface/score';
...
describe('CarpoolingDialogComponent', () => {
  ...
  beforeEach(() => {
    spyCarpoolingService = jasmine.createSpyObj('CarpoolingServiceInterface', ['book']);
    spyScoreService = jasmine.createSpyObj('ScoreServiceInterface', ['getScoreUserData']);
    spyNotiferService = jasmine.createSpyObj('NotifierServiceInterface', ['error']);
    spyScoreService.getScoreUserData.and.returnValue(of({
      driver_id: 0,
      first_name: 'John',
      last_name: 'Doe',

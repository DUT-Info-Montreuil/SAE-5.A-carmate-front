...
describe('PublishedCarpoolingsComponent', () => {
  ...
  beforeEach(() => {
    ...
    spyProfileService.getPassengerProfile.and.returnValue(
      of({
        user_id: 0,
        first_name: 'John',
        last_name: 'Doe',
  ...
  it('should initialize carpoolingToDisplay on ngOnInit', () => {
    ...
    expect(component.carpoolingToDisplay.max_passengers).toEqual(
      component.publishedCarpooling.max_passengers,
    );
    expect(component.carpoolingToDisplay.seats_takens).toEqual(
      component.publishedCarpooling.seats_taken!,
    );

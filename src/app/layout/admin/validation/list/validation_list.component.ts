...
export class ValidationComponent {
  ...
  constructor(
    ...
    @Inject(VALIDATION_SERVICE_TOKEN) protected validListService: ValidationServiceInterface,
  ...
  private generatePageButtons(page: number): { value: number; isCurrent: boolean }[] {
  ...
  public showDocument(document_id: number) {
    this.router.navigate(['/admin/license'], {queryParams: {document: document_id.toString()}});
  }

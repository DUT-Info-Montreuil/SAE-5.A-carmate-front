...
export interface Document {
  ...
  last_name: string
  account_type: AccountType
  document_type: LicenceType
  document: string
  document_id: number
}

export interface NextDocument {
  next_id_document: number
}
...
export const VALIDATION_SERVICE_TOKEN = new InjectionToken<ValidationServiceInterface>('ValidationServiceInterface');
